...
namespace TLSharp.Core.Utils
{
    public static class UploadHelper
    {
        ...
        public static async Task<TLAbsInputFile> UploadFile(this TelegramClient client, string name, StreamReader reader, CancellationToken token = default)
        {
        ...
        private static async Task<TLAbsInputFile> UploadFile(string name, StreamReader reader,
            TelegramClient client, bool isBigFileUpload, CancellationToken token = default)
        {
